            ...
            <div class="navbar">
                ...
                <div class="collapse navbar-toggleable-sm" id="collapse">
                    <div class="main-page-heading">
                        <h3> <span>Add Staff Member</span></h3>
                    </div>
                </div>
                <!-- / navbar collapse -->
            </div>
                ...
                <div class="row details-section">
                    ...
                    <div class="col-md-8">
                            ...
                            <div class="col-md-8">
                                <div class="row row-sm">
                                        ...
                                        <div class="form-group">
                                            <div class="radio">
                                                <label class="ui-check">
                                                    <input type="radio" name="a" value="keeper" class="has-value" checked>
                                    ...
                                    <div class="col-md-3">
                                        <div class="radio">
                                            <label class="ui-check">
                                                <input type="radio" name="a" value="wizard" class="has-value">
                                                <i class="dark-white"></i>
                                                Wizard
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="radio">
                                            <label class="ui-check">
                                                <input type="radio" name="a" value="deathEater" class="has-value">
                                                <i class="dark-white"></i>
                                                Death Eater
                                            </label>
                                        </div>
                        ...
                        <div class="form-group">
                            ...
                            &nbsp;&nbsp;
                            <a href="{{route('admin.staff.staff')}}" class="btn btn-outline b-primary text-primary"><i class="fa fa-ban"></i> &nbsp;Cancel</a>
                        </div>
                    </div>
                    <div class="col-md-4">
