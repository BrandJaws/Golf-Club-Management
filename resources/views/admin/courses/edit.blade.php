            ...
            <form action="{{route('admin.courses.update',$course['id'])}}" name="" method="post">
                ...
                <div class="col-md-8">
                    <div class="form-group {{($errors->has('name'))?'has-error':''}}">
                        ...
                        <input type="text" class="form-control" name="name" value="{{Request::old('name') ? Request::old('name') : $course['name']}}"/>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group {{($errors->has('openTime'))?'has-error':''}}">
                                ...
                                <input type="time" class="form-control" placeholder="AM" name="openTime"
                                       value="{{Request::old('openTime') ? Request::old('openTime') : Carbon\Carbon::parse($course['openTime'])->format('H:i')}}"/>
                        ...
                        <div class="col-md-6">
                            <div class="form-group {{($errors->has('closeTime'))?'has-error':''}}">
                                ...
                                <input type="time" class="form-control" placeholder="PM" name="closeTime"
                                       value="{{Request::old('closeTime') ? Request::old('closeTime') : Carbon\Carbon::parse($course['closeTime'])->format('H:i')}}"/>
                        ...
                        <div class="col-md-6">
                            <div class="form-group {{($errors->has('bookingInterval'))?'has-error':''}}">
                                ...
                                <input type="number" class="form-control" placeholder="Minutes" name="bookingInterval"
                                       value="{{Request::old('bookingInterval') ? Request::old('bookingInterval') : $course['bookingInterval']}}"/>
                        ...
                        <div class="col-md-6">
                            <div class="form-group {{($errors->has('bookingDuration'))?'has-error':''}}">
                                ...
                                <input type="number" class="form-control" placeholder="Minutes" name="bookingDuration"
                                       value="{{Request::old('bookingDuration') ? Request::old('bookingDuration') : $course['bookingDuration']}}"/>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <button type="submit" class="btn btn-def"><i class="fa fa-floppy-o"></i> &nbsp;Update
                                    Course
                                </button>
                                &nbsp;&nbsp;
