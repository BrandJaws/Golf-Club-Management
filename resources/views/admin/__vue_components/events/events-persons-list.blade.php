...
@include("admin.__vue_components.events.events-reserve-member-popup")
<script>

    Vue.component('events-persons-list', {
        ...
        <div>
         ...
         <events-reserve-member-popup @close-popup="closeReservePlayerPopup" @add-member="addMemberRequested" v-if="showReservePlayerPopup" :popupMessage="reservePlayerPopupMessage"></events-reserve-member-popup>
         <div class="row bg-white">
                    <div class="col-md-6">
                        <div class="main-page-heading">
                            <h3>
                                <span>Person Taking this Event</span>
                            </h3>
                        </div>
                    </div>
