      ...
      <div flex class="hide-scroll">
        <nav class="scroll nav-light">
          <ul class="nav">
            ...
            <li> <a href="#." > <span class="nav-icon"> <i class="material-icons">&#xe8d2; <span ui-include="'{{asset('assets/images/i_3.svg')}}'"></span> </i> </span> <span class="nav-text">Profile / Settings</span> </a> </li>
            ...
            <li> <a href="#." > <span class="nav-icon"> <i class="material-icons">&#xe8d2; <span ui-include="'{{asset('assets/images/i_3.svg')}}'"></span> </i> </span> <span class="nav-text">Social</span> </a> </li>
